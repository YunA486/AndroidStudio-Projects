package kr.hs.emirim.ex10_19_20;
...
public class MainActivity extends AppCompatActivity {
    ...
    View.OnClickListener btnListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()){
                case R.id.btn_call:
                    Uri uri = Uri.parse("tel:01033337777");
                ...
                case R.id.btn_homepage:
                    ...
                    break;
                case R.id.btn_map:
                    uri = Uri.parse("https://maps.google.co.kr/maps?q=" + 37.46859401728741 + "," + 126.93222117826838 + "&z=15");
                    intent = new Intent(Intent.ACTION_VIEW, uri);
                    break;
